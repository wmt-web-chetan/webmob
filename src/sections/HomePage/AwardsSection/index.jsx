...
//           <div className=" gap-8 lg:gap-12 xl:gap-16 2xl:gap-12 3xl:gap-24 items-center  !flex !flex-row ">
//             {/* Left Content */}
...
//             <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 lg:gap-3 xl:gap-4 2xl:gap-12 3xl:gap-6">
